...
pub use platform::{
    ...
    DS2_ECU_IDENTIFICATION_CAPABILITY, DS2_FAULT_MEMORY_CAPABILITY, GATEWAY_CLAIM,
    IDENTIFICATION_ENCODING, ISO15765_NORMAL_FIXED_LAYOUT_EVIDENCE, ISO9141_NODE_ADDRESSING_MODE,
    ISO_SETTINGS_CLAIM, ISO_WAKEUP_CLAIM, KWP2000_DIAGNOSTIC_PROTOCOL,
    KWP2000_READ_DTC_BY_STATUS_CAPABILITY, KWP2000_READ_ECU_IDENTIFICATION_CAPABILITY,
    NETWORK_CLAIM, NORMAL_FIXED_TESTER_ADDRESS, NORMAL_FIXED_TESTER_ADDRESS_EVIDENCE,
    PHYSICAL_ADDRESS_CLAIM, PLATFORM_PARSER_ID, UDS_DIAGNOSTIC_PROTOCOL,
    UDS_READ_DATA_BY_IDENTIFIER_CAPABILITY, UDS_READ_DTC_INFORMATION_CAPABILITY,
};
pub use text::{
