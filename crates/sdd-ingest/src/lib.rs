...
pub use platform::{
    PlatformAdapter, IDENTIFICATION_ENCODING, ISO15765_NORMAL_FIXED_LAYOUT_EVIDENCE, NETWORK_CLAIM,
    NORMAL_FIXED_TESTER_ADDRESS, NORMAL_FIXED_TESTER_ADDRESS_EVIDENCE, PHYSICAL_ADDRESS_CLAIM,
    PLATFORM_PARSER_ID, UDS_DIAGNOSTIC_PROTOCOL, UDS_READ_DATA_BY_IDENTIFIER_CAPABILITY,
