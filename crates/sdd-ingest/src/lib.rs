...
pub use dtc::{
    ...
    DTC_HELP_PARSER_ID, DTC_HELP_SCREEN_CLAIM_PREFIX, DTC_HELP_SCREEN_ITEMS_CLAIM_PREFIX,
    DTC_TYPE_DIMENSION, MODEL_YEAR_DESIGNATION_DIMENSION, MODULE_DATA_NAME_DIMENSION,
};
pub use dtc_index::{
...
pub use platform::{
    PlatformAdapter, DS2_DIAGNOSTIC_PROTOCOL, DS2_ECU_IDENTIFICATION_CAPABILITY,
    DS2_FAULT_MEMORY_CAPABILITY, IDENTIFICATION_ENCODING, ISO15765_NORMAL_FIXED_LAYOUT_EVIDENCE,
    ISO9141_NODE_ADDRESSING_MODE, ISO_SETTINGS_CLAIM, ISO_WAKEUP_CLAIM,
    KWP2000_DIAGNOSTIC_PROTOCOL, KWP2000_READ_DTC_BY_STATUS_CAPABILITY,
