...
pub use platform::{
    ...
    DS2_ECU_IDENTIFICATION_CAPABILITY, DS2_FAULT_MEMORY_CAPABILITY, ELEVEN_BIT_RESPONSE_OFFSET,
    ELEVEN_BIT_RESPONSE_OFFSET_EVIDENCE, GATEWAY_CLAIM, IDENTIFICATION_ENCODING,
