...
own rule and by three layers of refusal. Not yet seen on Windows — the next
CI build is the first that carries it — and the owner has not yet decided
whether that build is handed out as 0.9.2.
