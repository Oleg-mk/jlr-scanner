...
operation's, and the two days of rework answered them. Stage 2, step 1
now lacks one thing the decision allows and the built note left for a
later commit: the collective clear, one confirmation over every surveyed
module. The K-line path is still proved at the crate level only, the
