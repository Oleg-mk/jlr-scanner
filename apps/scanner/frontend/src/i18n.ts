...
const uk: Record<string, string> = {
  ...
  "Board unverified": "Плату не перевірено",
  "Adapter found": "Адаптер знайдено",
  "Adapter error": "Помилка адаптера",
  "No adapter": "Адаптера немає",
  Library: "Бібліотека",
  "Library: failed": "Бібліотека: помилка",
  "Library: built-in": "Бібліотека: вбудована",
  "Saving…": "Збереження…",
  ...
  // The one line under the map, and the list of what the check found (2026-09-18).
  "{known} modules known: {reachable} reachable over the adapter, {hypothesis} on an unverified route, {unreachable} not reachable.":
    "Відомо блоків: {known}. Через адаптер досяжні {reachable}, на неперевіреному маршруті {hypothesis}, недосяжні {unreachable}.",
  "No modules are known for this vehicle in the loaded data. Check the programme name and the SDD breakpoint marker, and that a library is loaded.":
    "У завантажених даних для цього авто не відомо жодного блока. Перевірте назву програми, маркер SDD і те, чи завантажена бібліотека.",
  "What the car answered": "ЩО ВІДПОВІВ АВТОМОБІЛЬ",
  "No fault codes": "Кодів несправностей немає",
  "{codes} fault code(s) in {modules} module(s)": "Кодів несправностей: {codes}, у блоках: {modules}",
  "{read} module(s) asked, {clean} answered with nothing, {failed} did not answer.":
    "Опитано блоків: {read}. Без кодів відповіли {clean}, не відповіли {failed}.",
  "Hide the codes": "Сховати коди",
  "Show the codes": "Показати коди",
  ...
  // What the read brings back, said before the list is opened (2026-09-18).
  "One value the module holds": "Одне значення, яке зберігає модуль",
  "Which value": "Яке значення",
  "Choose a value": "Оберіть значення",
  "What the module says it is": "Що модуль каже про себе",
  ...
  "Try the bench again; it needs no adapter.": "Спробуйте стенд ще раз; адаптер для нього не потрібен.",
  "The adapter state could not be updated.": "Не вдалося оновити стан адаптера.",
  "{name} detected": "Виявлено {name}",
  Connecting: "Підключення",
  "Choose adapter": "Оберіть адаптер",
  "Select a COM port": "Оберіть COM-порт",
  "Connecting…": "Підключення…",
  // What is being connected, while it is being connected (2026-09-18).
  "Connecting the bench…": "Підключення стенда…",
  "Connecting the adapter…": "Підключення адаптера…",
  "The virtual vehicle is being built from the library for the vehicle this session describes. Nothing is sent anywhere.":
    "Віртуальне авто збирається з бібліотеки для того автомобіля, який описала ця сесія. Нікуди нічого не надсилається.",
  "Opening the port and asking the board what it is.":
    "Відкриваємо порт і питаємо плату, що вона таке.",
  Connect: "Підключити",
  ...
  "The modules are being surveyed. The bench answers for what that survey finds, so it waits for it to end.":
    "Триває огляд блоків. Стенд відповідає за те, що знайде цей огляд, тому чекає його кінця.",
  "The modules are being surveyed; the bench is built from what that finds":
  ...
  "Found": "Знайдено",
  "What the test found: {count} code(s)": "Що знайшов тест: кодів {count}",
  "The test logged no new code; the module holds {count} code(s).": "Тест не записав нових кодів; модуль тримає кодів: {count}.",
  "SERVICE_ROUTINE · runs {seconds} s; the result is shown as the module answers it.": "SERVICE_ROUTINE · триває {seconds} с; результат показано так, як відповів модуль.",
  "Run the self test on {module}": "Запустити самотест на {module}",
  "Run the test {name} on {module}": "Запустити тест {name} на {module}",
  "Operation: run the routine {routine} · class SERVICE_ROUTINE": "Операція: запуск рутини {routine} · клас SERVICE_ROUTINE",
  "It runs {time} s; the tool waits {timeout} s at most.": "Триває {time} с; інструмент чекає щонайбільше {timeout} с.",
  "The result is shown as the module answers it; this library does not describe it.": "Результат показано так, як відповів модуль; ця бібліотека його не описує.",
  "Running: {elapsed} s of {time} s": "Виконується: {elapsed} с із {time} с",
  "Stop the test": "Зупинити тест",
  "The module answered: {result}": "Модуль відповів: {result}",
  "The module refused the test: {refusal}": "Модуль відмовив у тесті: {refusal}",
  "Stopped by you.": "Зупинено вами.",
  "The module gave no result in {timeout} s.": "Модуль не дав результату за {timeout} с.",
  "The test was not run.": "Тест не виконано.",
  "Self tests run": "Виконані самотести",
  Test: "Тест",
  Seconds: "Секунди",
  completed: "виконано",
  stopped: "зупинено",
  ...
  "Each run was confirmed by the person and is a service routine; the result is the bytes the module answered with, and this library does not describe them. Found: the codes the module held once the run had ended and not before it.":
    "Кожен запуск підтверджено людиною, і це сервісна рутина; результат — байти, якими відповів модуль, і ця бібліотека їх не описує. Знайдено: коди, які модуль тримав після закінчення тесту і не тримав до нього.",
  ...
  "Key readings": "Основні показники",
  "not watched": "не читається",
  "rpm × 1000": "об/хв × 1000",
  ...
  "Module passports": "Паспорти модулів",
  ...
  // A module read over a K-line (ADR-0029 slice B)
  ...
  "Prepare the document": "Підготувати документ",
  "Hide the document": "Сховати документ",
  "Print / save as PDF": "Друк / зберегти як PDF",
  "Save as a web page": "Зберегти як вебсторінку",
  "Bench session: nothing is written to disk.": "Сеанс стенда: на диск нічого не пишеться.",
  "Document written to {path}": "Документ записано у {path}",
  "Show in folder": "Показати в теці",
  "Diagnostic session report": "Звіт діагностичного сеансу",
  "ProwlOne {version} · build {build} · saved {saved}": "ProwlOne {version} · збірка {build} · збережено {saved}",
  "BENCH SESSION — a virtual vehicle answered from the data library. Every value in this document is synthetic and is evidence of nothing about any car.": "СЕАНС СТЕНДА — відповідав віртуальний автомобіль із бібліотеки даних. Кожне значення в цьому документі синтетичне і не є доказом нічого про жодне авто.",
  "Breakpoint": "Точка розділу",
  "Powertrain": "Силовий агрегат",
  "Manifests": "Маніфести",
  "Records": "Записи",
  "Sources": "Джерела",
  "Issued to": "Видано для",
  "Issue code": "Код видачі",
  "Valid until": "Дійсна до",
  "Backend": "Бекенд",
  "Identifier read": "Читання ідентифікатора",
  "Fault-code read": "Читання кодів",
  "Module reads": "Читання модулів",
  "Responder": "Відповідач",
  "When": "Коли",
  "What each module says it is, as the text it holds; nothing is compared with a catalogue.": "Те, чим модуль себе називає, тим текстом, який він тримає; ні з яким каталогом це не порівнюється.",
  "Every module that keeps a distance, as it keeps it. No verdict is drawn from a difference.": "Кожен модуль, який тримає пробіг, так, як він його тримає. З різниці не робиться жодного висновку.",
  "The values the modules hold; the rows SDD's own editor shows.": "Значення, які тримають модулі; рядки, які показує власний редактор SDD.",
  "Reads": "Читань",
  "{samples} sample(s) over {rounds} round(s); the series itself is in the bundle and the spreadsheet.": "{samples} зразків за {rounds} кіл; сама серія — у пакеті й у таблиці.",
  "Also recorded": "Також записано",
  "Count": "Кількість",
  "Bus captures": "Прослуховування шини",
  "Standard OBD-II reads": "Читання стандартного OBD-II",
  "Calibration reads": "Читання калібрування",
  "Each is in the bundle whole, with its own bytes and its own validation.": "Кожне лежить у пакеті цілим, зі своїми байтами і своїм станом перевірки.",
  "This session recorded nothing yet.": "Цей сеанс поки нічого не записав.",
  "This document shows what the modules answered. It states no threshold of its own, judges nothing, and nothing in it is vehicle-confirmed by being here: the session bundle beside it is the record.": "Цей документ показує, що відповіли модулі. Він не встановлює власних порогів, нічого не оцінює, і ніщо в ньому не стає підтвердженим на авто через те, що воно тут: записом є пакет сеансу поряд.",
...
const ru: Record<string, string> = {
  ...
  "Board unverified": "Плата не проверена",
  "Adapter found": "Адаптер найден",
  "Adapter error": "Ошибка адаптера",
  "No adapter": "Адаптера нет",
  Library: "Библиотека",
  "Library: failed": "Библиотека: ошибка",
  "Library: built-in": "Библиотека: встроенная",
  "Saving…": "Сохранение…",
  ...
  // The one line under the map, and the list of what the check found (2026-09-18).
  "{known} modules known: {reachable} reachable over the adapter, {hypothesis} on an unverified route, {unreachable} not reachable.":
    "Известно блоков: {known}. Через адаптер достижимы {reachable}, на непроверенном маршруте {hypothesis}, недостижимы {unreachable}.",
  "No modules are known for this vehicle in the loaded data. Check the programme name and the SDD breakpoint marker, and that a library is loaded.":
    "В загруженных данных для этого автомобиля не известно ни одного блока. Проверьте название программы, маркер SDD и то, загружена ли библиотека.",
  "What the car answered": "ЧТО ОТВЕТИЛ АВТОМОБИЛЬ",
  "No fault codes": "Кодов неисправностей нет",
  "{codes} fault code(s) in {modules} module(s)": "Кодов неисправностей: {codes}, в блоках: {modules}",
  "{read} module(s) asked, {clean} answered with nothing, {failed} did not answer.":
    "Опрошено блоков: {read}. Без кодов ответили {clean}, не ответили {failed}.",
  "Hide the codes": "Скрыть коды",
  "Show the codes": "Показать коды",
  ...
  // What the read brings back, said before the list is opened (2026-09-18).
  "One value the module holds": "Одно значение, которое хранит модуль",
  "Which value": "Какое значение",
  "Choose a value": "Выберите значение",
  "What the module says it is": "Что модуль говорит о себе",
  ...
  "Try the bench again; it needs no adapter.": "Попробуйте стенд ещё раз; адаптер для него не нужен.",
  "The adapter state could not be updated.": "Не удалось обновить состояние адаптера.",
  ...
  "Connecting…": "Подключение…",
  // What is being connected, while it is being connected (2026-09-18).
  "Connecting the bench…": "Подключение стенда…",
  "Connecting the adapter…": "Подключение адаптера…",
  "The virtual vehicle is being built from the library for the vehicle this session describes. Nothing is sent anywhere.":
    "Виртуальный автомобиль собирается из библиотеки для того автомобиля, который описала эта сессия. Никуда ничего не отправляется.",
  "Opening the port and asking the board what it is.":
    "Открываем порт и спрашиваем плату, что она такое.",
  Connect: "Подключить",
  ...
  "The modules are being surveyed. The bench answers for what that survey finds, so it waits for it to end.":
    "Идёт осмотр модулей. Стенд отвечает за то, что найдёт этот осмотр, поэтому ждёт его конца.",
  "The modules are being surveyed; the bench is built from what that finds":
  ...
  "Found": "Найдено",
  "What the test found: {count} code(s)": "Что нашёл тест: кодов {count}",
  "The test logged no new code; the module holds {count} code(s).": "Тест не записал новых кодов; модуль держит кодов: {count}.",
  "SERVICE_ROUTINE · runs {seconds} s; the result is shown as the module answers it.": "SERVICE_ROUTINE · длится {seconds} с; результат показан так, как ответил модуль.",
  "Run the self test on {module}": "Запустить самотест на {module}",
  "Run the test {name} on {module}": "Запустить тест {name} на {module}",
  "Operation: run the routine {routine} · class SERVICE_ROUTINE": "Операция: запуск процедуры {routine} · класс SERVICE_ROUTINE",
  "It runs {time} s; the tool waits {timeout} s at most.": "Длится {time} с; инструмент ждёт не более {timeout} с.",
  "The result is shown as the module answers it; this library does not describe it.": "Результат показан так, как ответил модуль; эта библиотека его не описывает.",
  "Running: {elapsed} s of {time} s": "Выполняется: {elapsed} с из {time} с",
  "Stop the test": "Остановить тест",
  "The module answered: {result}": "Модуль ответил: {result}",
  "The module refused the test: {refusal}": "Модуль отказал в тесте: {refusal}",
  "Stopped by you.": "Остановлено вами.",
  "The module gave no result in {timeout} s.": "Модуль не дал результата за {timeout} с.",
  "The test was not run.": "Тест не выполнен.",
  "Self tests run": "Выполненные самотесты",
  Test: "Тест",
  Seconds: "Секунды",
  completed: "выполнено",
  stopped: "остановлено",
  ...
  "Each run was confirmed by the person and is a service routine; the result is the bytes the module answered with, and this library does not describe them. Found: the codes the module held once the run had ended and not before it.":
    "Каждый запуск подтверждён человеком, и это сервисная процедура; результат — байты, которыми ответил модуль, и эта библиотека их не описывает. Найдено: коды, которые модуль держал после окончания теста и не держал до него.",
  ...
  "Key readings": "Основные показатели",
  "not watched": "не читается",
  ...
  "Module passports": "Паспорта модулей",
  ...
  "Prepare the document": "Подготовить документ",
  "Hide the document": "Скрыть документ",
  "Print / save as PDF": "Печать / сохранить как PDF",
  "Save as a web page": "Сохранить как веб-страницу",
  "Bench session: nothing is written to disk.": "Сеанс стенда: на диск ничего не пишется.",
  "Document written to {path}": "Документ записан в {path}",
  "Show in folder": "Показать в папке",
  "Diagnostic session report": "Отчёт диагностического сеанса",
  "ProwlOne {version} · build {build} · saved {saved}": "ProwlOne {version} · сборка {build} · сохранено {saved}",
  "BENCH SESSION — a virtual vehicle answered from the data library. Every value in this document is synthetic and is evidence of nothing about any car.": "СЕАНС СТЕНДА — отвечал виртуальный автомобиль из библиотеки данных. Каждое значение в этом документе синтетическое и не является доказательством ничего ни о каком автомобиле.",
  "Breakpoint": "Точка разделения",
  "Powertrain": "Силовой агрегат",
  "Manifests": "Манифесты",
  "Records": "Записи",
  "Sources": "Источники",
  "Issued to": "Выдана для",
  "Issue code": "Код выдачи",
  "Valid until": "Действительна до",
  "Backend": "Бэкенд",
  "Identifier read": "Чтение идентификатора",
  "Fault-code read": "Чтение кодов",
  "Module reads": "Чтения модулей",
  "Responder": "Отвечающий",
  "When": "Когда",
  "What each module says it is, as the text it holds; nothing is compared with a catalogue.": "То, чем модуль себя называет, тем текстом, который он хранит; ни с каким каталогом это не сравнивается.",
  "Every module that keeps a distance, as it keeps it. No verdict is drawn from a difference.": "Каждый модуль, который хранит пробег, так, как он его хранит. Из разницы не делается никакого вывода.",
  "The values the modules hold; the rows SDD's own editor shows.": "Значения, которые хранят модули; строки, которые показывает собственный редактор SDD.",
  "Reads": "Чтений",
  "{samples} sample(s) over {rounds} round(s); the series itself is in the bundle and the spreadsheet.": "{samples} образцов за {rounds} кругов; сама серия — в пакете и в таблице.",
  "Also recorded": "Также записано",
  "Count": "Количество",
  "Bus captures": "Прослушивания шины",
  "Standard OBD-II reads": "Чтения стандартного OBD-II",
  "Calibration reads": "Чтения калибровки",
  "Each is in the bundle whole, with its own bytes and its own validation.": "Каждое лежит в пакете целиком, со своими байтами и своим состоянием проверки.",
  "This session recorded nothing yet.": "Этот сеанс пока ничего не записал.",
  "This document shows what the modules answered. It states no threshold of its own, judges nothing, and nothing in it is vehicle-confirmed by being here: the session bundle beside it is the record.": "Этот документ показывает, что ответили модули. Он не устанавливает собственных порогов, ничего не оценивает, и ничто в нём не становится подтверждённым на автомобиле оттого, что оно здесь: записью является пакет сеанса рядом.",
  // The battery (ADR-0030)
  "Battery": "Аккумулятор",
